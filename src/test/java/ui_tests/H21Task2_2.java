...
public class H21Task2_2 {
    ...
    public void test() {
        ...
        for (int x = 0; x < numberOfPages.length; x++) {
            ...
            elementsList.forEach(s -> myList.add(s.getText()));
            ...
            assertTrue(driver.findElement(By.cssSelector("a[data-ved='2ahUKEwjelYbmu9jwAhVx-SoKHYX0C6QQFjADegQIFBAD']")).isDisplayed());
        }
    }
}
